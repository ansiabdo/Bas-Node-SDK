...
class PaytmChecksum {
	...
	static encrypt(input, key) {
		var cipher = crypto.createCipheriv('AES-256-CBC', key, PaytmChecksum.iv);
		var encrypted = cipher.update(input, 'binary', 'base64');
		encrypted += cipher.final('base64');
		return encrypted;
	}
	static decrypt(encrypted, key) {
		var decipher = crypto.createDecipheriv('AES-256-CBC', key, PaytmChecksum.iv);
	...
	static generateSignature(params, key) {
		...
		return PaytmChecksum.generateSignatureByString(params, key2);
	}

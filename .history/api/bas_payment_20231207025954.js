...
var BasChecksumJS = require('./checksum-js.js');
...
router.get('/status/:orderId', async (req, res) => {
    ...
    let key = 'R0Biem8wOUIySkJxNGd6cQ=='
    let plaintext = "a570f6d353a409291fd9c3db1b9d8b4b06cac6cd5b5a31318c41b151432115deaaaa"

    console.log("status req.params :", req.params)
    let aes = BasChecksumJS.encryptAES(plaintext, key)
    console.log("=============== body aes:", aes);
    console.log("=============== body aes:", btoa(aes));

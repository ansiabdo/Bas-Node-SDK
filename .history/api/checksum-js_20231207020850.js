...
class BasChecksumJS {
    ...
    static encryptAES = (data, key) => {
        ...
        console.log("============ encryptAES key2:", key2.toString())
        console.log("============ encryptAES key2:", key2.toString(CryptoJS.enc.Utf8))
        console.log("============ encryptAES key2:", key2.toString(CryptoJS.enc.Base64))
        console.log("============ encryptAES iv2:", iv2)
        var encrypted = CryptoJS.AES.encrypt(data, key2, {
            iv: iv2,
            mode: CryptoJS.mode.CBC,
            padding: CryptoJS.pad.Pkcs7
        }).toString();

        console.log("============ encryptAES encrypted:", encrypted)
